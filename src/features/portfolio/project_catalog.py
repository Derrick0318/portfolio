        ...
        "resources": [
            {
                ...
                "description": "Open the brochure directly in the page for a quick project overview.",
                "type": "pdf",
                "filename": "pdfs/BROCHURE.pdf",
                "endpoint": "crop_yield.assets",
                "button_text": "Open brochure",
            },
            {
                "label": "Crop Yield Poster",
                "description": "Open the poster directly in the page without downloading.",
                "type": "pdf",
                "filename": "pdfs/POSTER.pdf",
                "endpoint": "crop_yield.assets",
